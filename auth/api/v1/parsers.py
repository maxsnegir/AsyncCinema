...
create_role_parser.add_argument("name", type=str, required=True, help="Role name is required")
create_role_parser.add_argument("description", type=str, required=False)

patch_role_parser = reqparse.RequestParser()
patch_role_parser.add_argument("name", type=str, required=False)  # TODO how to make one of them required to change smth
...
role_parser.add_argument('description', type=str, required=False, help='Role description is required')
...
assign_role_parser.add_argument("description", type=str, required=False, help="Role description is required")
