...
auth_history_parser.add_argument('page_number', type=int, default=0, required=False, location="form")
auth_history_parser.add_argument('page_size', type=int, default=10, required=False, location="form")
